        ...
        <section className="main section motion-preset-focus">
          ...
          <div className="headlineWrapper">
            <p className="headline">
              ...
              and you're ready to build and share something amazing with the
              world. Now what? This post will walk you through creating a GitHub
          ...
          <div>
            ...
            <p>
              ...
              to save a few keyboard strokes. Give your repository a name and
              set it to "public". No need to bother with any of the other
              settings for now.
            </p>
            {/* Divider */}
            <div className="divider border-b border-accent"></div>
          ...
          <div>
            ...
            <p>
              You'll want to save your app to your computer and sync it to
              GitHub. So, we'll create a folder for our app and we'll clone our
              GitHub repository to the same folder.
            </p>
            <p>
              ...
              our changes locally using all of the wonderful capabilities
              provided by a version control system known as git. To learn more
              about git, check out their{" "}
              <span>
          ...
          <div>
            ...
            <p>
              ...
              tutorial for creating your new React app. Make sure you're still
              in your "my_app" directory when creating your new React
              application. Once you're ready to save your changes, save them
              locally and then push your code to GitHub. See below for example
              code you can use to stage, commit, and push your changes to
              GitHub.
            </p>
            {/* Code Snippet */}
          ...
          <div>
            ...
            <p>
              The production build is an web optimized version of our app. This
              is the version we'll post to GitHub Pages. Production builds
              improve load time which makes for happier users. So run that build
              and get ready to deploy your app.
            </p>
            {/* Code Snippet */}
          ...
          <div>
            ...
            <p>
              ...
              deploying your application from a GitHub repository to GitHub
              Pages is, as you should expect, very easy. Simply go to "Settings"
              and "Pages" page, select "Deploy from a branch" as your "Source"
              and pick a branch from the "Branch" dropdown which will be used to
          ...
          <div>
            ...
            <p>
              ...
              follow the previous steps (i.e., stage, commit, push, build) and
              if you'd like to publish updates to your GitHub Pages page from
              the comfort of your terminal, just install the NPM package called
              <span>
                {" "}
                <a
              ...
              and set up a package.bash "deploy" script to push your code to
              your GitHub Pages page as is illustrated below. Godspeed!
            </p>
            {/* Code Snippet */}
