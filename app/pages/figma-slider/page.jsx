      ...
      <section className="main section motion-preset-focus">
        ...
        <div className="headlineWrapper">
          <p className="headline">
            I'm building a mockup in Figma for a new feature at work and I've
        ...
        <div>
          ...
          <p>
            ...
            Most sliders increment in single digits or, at the most, no more
            than two decimal points, but to build out such a granular slider in
            Figma wouldn't be practical. Luckily, we don't build apps in Figma
            we build prototypes of apps (which means they don't have to be
            perfect representations of the real thing).
          </p>
          <p>
            ...
            building our slider, let's give it a home to live in within Figma.
        ...
        <div>
          ...
          <p>
            ...
            as as a real slider since the slider, in our case, can only be in
            three positions, but it gets the point across and, if you really
            have the time, you can choose to make more variants that go win
            smaller increments (such as in increments of .10 ranging from 0 to
            1. For the purposes of this tutorial, we'll keep things simple.
          </p>
          {/* Divider */}
          <div className="divider border-b border-accent"></div>
        </div>
