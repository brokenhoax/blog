        ...
        <div>
          ...
          >
            <p>
              ...
              firewall and our core router and that's just scratching the
              ...
              considering how much responsibility we put on pfSense in our home
              lab, it makes sense to me to go with Netgate. The 4200, in
          ...
          >
            <p>
              ...
              in your lab (like that HP 2915 switch)
            </p>
          </KcLink>
          ...
          >
            <p>
              ...
              strongly suggest you get yourself a copy of the Network+ exam
              guide. It will teach you everything you need to know your way
              around your home lab's network. Plus, if you take the exam you can
              add it to your resume and that's never a bad thing! That said, I'm
              not going to teach concepts like IP addressing, subnetting, etc.,
              as it's assumed that you are familiar with those already. However,
              I will make recommendations and provide direction when we
              encounter new concepts along the way.
            </p>
          </KcLink>
        </div>
        {/* Divider */}
