        ...
        <section className="section motion-preset-focus">
          ...
          <div>
            ...
            <p>
              ...
              combined into one single modem/router appliance and provided by
              your internet provider, but everybody's situtation is different.
              Either way, the lion's share of work we'll be working on will be
              our Netgate appliance and everything connected downstream from it.
            </p>
            <p>
              ...
              <span className="italic"> behind</span> your shared Wi-Fi. Why?
              You will break your lab many times over as you build it out.
              That's why I chose to place my lab behind my router. With this
              design, I should never disrupt the home Wi-Fi because my router
              sits in front of my lab and the router is all my family needs to
              get online. If I break something in my lab, the home Wi-Fi keeps
              humming along. That said, you can also connect your Netgate
              appliance directly to your modem or ethernet internet handoff and
              place your wireless router behind your firewall. That would be a
              more secure design after all but, for now, let's focus on
              following the lab and being a good steward of the home Wi-Fi.
            </p>
            {/* Divider */}
            <div className="divider border-b border-accent"></div>
          </div>
          ...
          <div>
            ...
            <p>
              The lab environment we're going to build in this Home Lab series
              is something anybody can build in a few weekends. All it takes is
              a fairly-new computer, an internet connection, about $2-3K for lab
              ...
              tech because bootcamps, certifications, and degrees cost at least
              as much if not significantly more and with a home lab you're
              getting hands-on experience. Another benefit of building a home
              lab is that you own the environment and can use it in any way you
              wish. You could build your own online shop and run your own small
              business. You can use your lab to build your own production studio
              and run a legitimate YouTube channel. There are a ton of awesome
              things you can do once you have the right mix of tech in your home
              lab. Build yourself a lab. It'll be good for you!
            </p>
            <p>
            ...
            <div>
              ...
              >
                <div>
                  ...
                  <p>
                    ...
                    renting hardware from my ISP, so I always opt to bring my
                    own modem and wireless router. This gives me full control
                    over all hardware on my premise and if you want full control
              ...
              >
                <div>
                  ...
                  <p>
                    ...
                    considering its age. So, I'm recommending the latest version
                    of Amplifi home router—the "Alien WiFi 6" router. You can
                    definitely find something that costs a lot less, but the
                    quality, performance, feature set, and ease of use is worth
                    the extra investment. If there were an area to save when
                    picking out your lab compenents, this might be it, but while
                    there's a plethora of cheap options to choose from out
                    there, I wouldn't go less than $100 for a decent modern home
                    wireless router.
                  </p>
                </div>
              </KcLink>
              ...
              >
                <p>
                  ...
                  our firewall and our core router and that's just scratching
                  the surface of how we'll be using pfSense on our Netgate
                  appliance. Netgate, being the official sponsor of the pfSense
                  open-source project, is the obvious choice for an out of the
                  box security appliance running pfSense. Yes, you could always
                  get something cheaper on Amazon and install pfSense on it
                  yourself, but considering how much responsibility we put on
                  pfSense in our home lab, it makes sense to me to go with
                  Netgate. The 4200, in particular, will provide us with four
                  routable interfaces supporting up to 2.5Gbps, giving us plenty
              ...
              >
                <p>
                  ...
                  anything too sophisticated and the HP 2915al is more than up
                  to the task. Obviously, for anybody reading this in 2025 and
                ...
                <p>
                  ...
                  interfaces, but you don't necessarily need that since we won't
                  be using all of them to build our our home lab. Your switch
                  will need to support VLANs (IEEE 802.1Q) and and it couldn't
                  hurt to find one that is capable of powering devices connected
                  to it (devices like a wireless access point that we'll be
                  adding to our lab in a future post). The 2915al is also
                  capable of inter-VLAN routing, which means it can route
                  traffic between interfaces that are on separate VLANs, but I
                  disable that feature in our lab so you won't need it anyways.
                  All routing will be handled by our Netgate network security
                  appliance for better control and security of our network
                  traffic.
                </p>
              </KcLink>
              ...
              >
                <p>
                  ...
                  your lab simultaneously. That's why I went with the new MS-01
                  by Minisforum. For starters, it has the home lab community all
                  ...
                  memory will give you room to grow for quite some time. If
                  stock is limited, consider buying either pre-configured or
                  bare-bones configurations and customizing with more storage,
                  memory, PCIe expansion, etc. This thing is awesome. Make it
                  your own!
                </p>
              </KcLink>
              {/* Network Rack */}
              ...
              >
                <p>
                  ...
                  yours, so it's time to invest in a network rack. You can go
                  with a floor rack or one that mounts to the wall, as is
                  depicted in my home lab. Choose whatever is best suited for
                  your space; however, an added benefit of a wall-mounted
                  network rack is that the odds of water frying your lab gear is
                  far less likely if it's not touching the floor. Plus, you'll
                  have less dust sucked up by the fans in your hardware when
                  wall mounted. It's helpful to plan out your rack layout ahead
                  of time so that you can pick up the right number of shelves
                  and mix of Ethernet cables of various lengths to make all of
                  your connections.
                </p>
              </KcLink>
              {/* Ethernet Cables */}
              ...
              >
                <p>
                  ...
                  identification. We're not running a production environment
                  here, and it's not going to be that complex; however, good
                  cable management will help keep your hardware accessible and
                  also improve airflow to your components.
                </p>
              </KcLink>
              ...
              >
                <p>
                  <Image
                    ...
                    loading="eager"
                  ></Image>
                  If your computer isn't equipped with an ethernet interface,
                  and most likely it's not, then you'll need pick up one of
                  these adapters. Newer computers come with USB-C ports on them,
                  but be sure to double-check that you have what you need (e.g.,
                  Do you have a USB port to spare? Do you need USB-A adapter
                  instead?) because you'll be hardwired to the network switch
                  while building out your homelab.
                </p>
              </KcLink>
              ...
              >
                <p>
                  ...
                  it, especially if you plan on using some refurbished
                  networking gear in your lab (like that HP 2915 switch)
                </p>
              </KcLink>
              ...
              >
                <p>
                  ...
                  We'll be loading Proxmox on to our Minisforum MS-01 server in
                  an upcoming course and we'll need a spare flash drive with at
                  least 2GB of room for the task. I can't believe how much
                  storage you can get for ~$11 these days. It almost feels
                  illegal!
                </p>
              </KcLink>
              {/* Network+ Exam Guide */}
              ...
              >
                <p>
                  <Image
                    ...
                    loading="eager"
                  ></Image>
                  For those of you with less experience with computer
                  networking, I strongly suggest you get yourself a copy of the
                  Network+ exam guide. It will teach you everything you need to
                  know your way around your home lab's network. Plus, if you
                  take the exam you can add it to your resume and that's never a
                  bad thing! That said, I'm not going to teach concepts like IP
                  addressing, subnetting, etc., as it's assumed that you are
                  familiar with those already. However, I will make
                  recommendations and provide direction when we encounter new
          ...
          <div>
            ...
            >
              <div>
                <p>
                  ...
                  drive to boot and install Proxmox, and Rufus is my go-to
                  bootable USB flash drive utility for Windows. Click the link
                  to go to the{" "}
            ...
            >
              <p>
                ...
                applications. So, it goes that any decent lab will inevitably
                need to support at least a handful of different operating
                systems. In our case, our web server will run in an Ubutntu
                Desktop virtual server in Proxmox and our Zscaler App Connector,
                running on Red Hat Enterpise Linux, will be our second virtual
                server running in Proxmox. By the time we're done with this lab
                series, we'll have four virtual macines running. Proxmox is an
                amazing piece of technology and the fact that it's free to use
                is remarkable. Consider subscribing for Proxmox support as a
            ...
            >
              <p>
                ...
                Proxmox. Within Ubuntu, we'll run our Nginx web server which
                we'll use to host our website. If you'd rather use a different
                Linux distribution, or go with an entirely different OS to host
                your web server, feel free to mix it up. So long as your OS of
                choice can run Nginx you should have no problem following along
                in subsequent labs.
              </p>
            </KcLink>
            {/* Red Hat Enterprise Linux Server */}
            ...
            >
              <p>
                ...
                system in order to be properly supported. Red Hat Enterprise
                Linux (RHEL) is the go-to Linux distribution for business
              ...
              <p>
                ...
                . This version cannot be used for commercial purposes, so read
                the fine print, but using the Developer program should save you
                around $380 per year on licensing RHEL for your lab. Sweet!
              </p>
            </KcLink>
            {/* pfSense */}
            <KcLink
            ...
            >
              <p>
                ...
                the community (e.g., YouTube). As it pertains to our lab,
                pfSense will handle our routing and network security while also
                providing other ancillary services. It really is a core
                component of our lab and a Swiss Army knife that we'll be
                reaching for throughout the rest of this series. pfSense comes
                pre-installed on the Netgate 4200 appliance, so I've linked to
                the official documentation for quick reference.
              </p>
            </KcLink>
            {/* Next.js */}
            <KcLink
            ...
            >
              <p>
                ...
                We're going to take you to the point where you essentially have
                a "Hello, World!" page in just a few commands. Developing it
                into a legitimate website, or, even better, a full-blown web
                app, is out of scope for this lab series. If learning to code is
                something you're interested in then I'd recommend checking out{" "}
            ...
            >
              <p>
                ...
                need for our lab purposes. Running on our Ubuntu virtual
                machine, Nginx is the web server we'll use to serve up our
                website to the world. At the end of the Nginx lab you'll see
                your work come together with your own personal home lab and
                cloud!
              </p>
            </KcLink>
            {/* Divider */}
            ...
            <div>
              ...
              <div>
                <p>
                  ...
                  address that you're issued, be it Static or Dynamic. A Static
                  IP address will always be the same. A Dynamic IP address will
                  eventually if not frequently change. So, if you have a Dynamic
                  IP address issued by your Internet Service Provider, then
                  you'll want to use Dynamic Domain Name System (DDNS) to keep
                  keep your IP address updated with your web hosting provider.
                  We will be using Cloudflare in this lab. If you choose another
                  web hosting provider, just make sure that they have an API
                  that allows you to use DDNS to update your web host with your
                  IP address.
                </p>
                <Callout
              ...
              >
                <p>
                  ...
                  Cloudflare is an excellent choice, becuase they have an open
                  API which we'll use in conjunction with Dynamic Domain Name
                  System (DDNS) on our Netgate appliance. DDNS will help us
                  maintain our presence on the web, by regularly updating
                  Cloudflare with our public IP address. For those of us with a
                  dynamic IP address issued to us by our Internet Service
                  Provider (ISP), this is a must have. Whomever you choose as
                  your registrar, if you have a dynamic IP address then either
                  ...
                  surely come with a surcharge making Cloudflare an obvious
                  choice.
                </p>
              </KcLink>
              ...
              >
                <p>
                  ...
                  of differnet types of users with different requirements. If
                  you think about a typical business, you have all sorts of
                  different users types demanding different things of your
                  network. There are administrators, employees, and even guests.
                  Even within "employees" there are various departments and
                  groups that may require differentiated access to various
                  aspects of the network or systems within it. As our lab
                  matures, we'll want to experiement with how we can provide
                  differented access to our users, and in order to do that we'll
                  need an Identity Provider (IdP) like Okta to help us manage
                  our user accounts. Okta is the perfect IdP for our home lab,
                  because not only are they a leading enterprise-grade player in
                  the identity space, but they also provide free developer
              ...
              >
                <p>
                  ...
                  remote access solution that you likely won't be able to get
                  your hands on outside of an enterprise agreement with Zscaler.
                  We will explore budget remote access solutions in a future
                  post. For now, it's just good to be aware of enterprise-grade
                  security solutions that are solving security problems at
                  scale.
                </p>
              </KcLink>
              ...
              >
                <p>
                  ...
                  leaving our network, that is, traffic going out to the
                  Internet. While our Netgate security appliance provides us
                  with internal network security for our east/west traffic
                  (i.e., at layers 3 and 4 of the OSI model), it doesn't do much
                  for us as far as keeping us safe on the web. Furthermore, ZIA
                  is an enterprise-level Security Service Edge (SSE) solution
                  that most home labs won't be able to implement unless you can
                  get your hands on a Zscaler tenant through your employer. In
                  future posts, we'll explore how we can best secure our
