      ...
      <section className={`section motion-preset-focus`}>
        ...
        <div className={`${styles.aboutKrausCloud}`}>
          ...
          <div className={`${styles.krausCloudWrapper}`}>
            <p className="italic">
              Kraus Cloud is an educational tech blog. It explores topics such
              as home labs, web development, web design, cybersecurity,
              networking, linux, and other similar subjects. If you're
              interested in gaining experience with any of these topics, no
              matter what your skill level, then you've come to the right place.
            </p>
            <p className="italic">
              Kraus Cloud is self-hosted and serves as a guide for you to build
              your own Cloud. By following the free content on this site, you
              can build your own home lab, website, and personal cloud and
              you'll learn a lot of valuable skills along the way. Kraus Cloud
              was built using technologies including Next.js (React), NodeJS,
              TailwindCSS, pfSense, Proxmox, Red Hat, and Nginx to name a few.
              Also, and perhaps it goes without saying, a lot of coffee and late
              nights.
            </p>
          </div>
        </div>
