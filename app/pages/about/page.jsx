...
function About() {
  ...
  return (
    <div className="gridContainer">
          ...
          <div className={`${styles.aboutKrausCloud}`}>
            ...
            <div className={`${styles.krausCloudWrapper}`}>
              ...
              <p className="italic">
                ...
                Nginx to name a few. Also, and perhaps it goes without saying, a
                lot of coffee and late nights.
              </p>
            </div>
          </div>
          {/* Divider */}
                ...
                <div>
                  ...
                  <div className={`${styles.textWrapper}`}>
                    <p>
                      ...
                      many hats. I've been a tech seller, a tech buyer, a
                      creator and a user. My employers have been some of the
                      largest and most storied in the business (IBM) to some of
                      the smaller/more niche players vying to make their mark
                      (Convr).
                    </p>
                    <p>
                      That said, most of what I know I've learned from strangers
                      on the internet and mostly for free. To return the favor
                      and to share what I've learned, I've built my own Cloud.
                    </p>
                    <p>
      ...
      <div className={`footer bg-primary text-accent border-t border-t-subtle`}>
        <Footer></Footer>
      </div>
    </div>
  );
