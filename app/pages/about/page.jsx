  ...
  function trackSocial(param) {
    ...
    if (param === "linkedin") {
      ...
      if (krausLinkedInReviewed === "true") {
        ...
        setLinkedInReview(!linkedInReviewed);
      }
      console.log(linkedInReviewed);
    }
  }
  ...
  return (
    <section className={`section motion-preset-focus`}>
      ...
      <div className={`${styles.aboutKrausCloud}`}>
        <p className="italic">
          Kraus Cloud is an educational tech blog. It explores topics such as
          home labs, web development, web design, cybersecurity, networking,
          linux, and other similar subjects. If you're interested in gaining
          experience with any of these topics, no matter what your skill level,
          then you've come to the right place.
        </p>
        <p className="italic">
          Kraus Cloud is self-hosted and serves as a guide for you to build your
          own Cloud. By following the free content on this site, you can build
          your own home lab, website, and personal cloud and you'll learn a lot
          of valuable skills along the way. Kraus Cloud was built using
          technologies including Next.js (React), NodeJS, TailwindCSS, pfSense,
          Proxmox, Red Hat, and Nginx to name a few. Also, and perhaps it goes
          without saying, a lot of coffee and late nights.
        </p>
      </div>
      {/* Divider */}
      <div className="divider border-b border-accent"></div>
        ...
        <div className={`${styles.writerWrapper}`}>
          ...
          <div>
            <p>
              ...
              Almost twenty years in to my career and I've worn many hats. I've
              been a tech seller, a tech buyer, a creator and a user. My
              employers have been some of the largest and most storied in the
              business (IBM) to some of the smaller/more niche players vying to
              make their mark (Convr).
            </p>
            <p>
              That said, most of what I know I've learned from strangers on the
              internet and mostly for free. To return the favor and to share
              what I've learned, I've built my own Cloud.
            </p>
            <p>
              If you'd like to connect professionally, please reach out using
              the link provided below and, if you're just here out of
              curiousity, be sure to check out{" "}
